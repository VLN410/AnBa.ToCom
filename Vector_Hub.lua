...
if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then 
	...
	function LoadSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfolder("AnBaToCom Hub") then
				makefolder("AnBaToCom Hub")
			end
			if not isfolder("AnBaToCom Hub/Blox Fruits/") then
				makefolder("AnBaToCom Hub/Blox Fruits/")
			end
			if not isfile("AnBaToCom Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				writefile("AnBaToCom Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
			else
				local Decode = game:GetService("HttpService"):JSONDecode(readfile("AnBaToCom Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
	...
	function SaveSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfile("AnBaToCom Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				...
				writefile("AnBaToCom Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
			end
		else
			return warn("Status : Undetected Executor")
		end
...
FakeDamage("AnBaToCom Hub")
Vec("<Color=Yellow>AnBaToCom Hub loaded Finished<Color=/>")
